...
-- list employee name with their manager and senior manager
-- name. senior manager is manager's manager

select e1.emp_id as employee,e1.emp_name, 
e2.emp_name as managers, e3.emp_name as senior_manager
